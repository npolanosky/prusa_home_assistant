...
from homeassistant.const import PERCENTAGE, UnitOfTemperature, UnitOfTime, UnitOfLength
...
class PrusaConnectSensorDescription(SensorEntityDescription):
    ...
    available_fn: Callable[[PrusaConnectData], bool] = lambda data: data.is_online
